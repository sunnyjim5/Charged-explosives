...
import net.monoten.chargedex.init.ChargedExplosivesModTabs;
import net.monoten.chargedex.init.ChargedExplosivesModItems;
...
@Mod("charged_explosives")
public class ChargedExplosivesMod {
	public static final Logger LOGGER = LogManager.getLogger(ChargedExplosivesMod.class);
	public static final String MODID = "charged_explosives";

	public ChargedExplosivesMod(IEventBus modEventBus) {
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		ChargedExplosivesModBlocks.REGISTRY.register(modEventBus);

		ChargedExplosivesModItems.register(modEventBus);

		ChargedExplosivesModTabs.REGISTRY.register(modEventBus);
